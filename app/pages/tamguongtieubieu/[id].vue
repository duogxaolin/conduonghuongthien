  ...
  <div class="article-detail-page section-bg">
    <div class="container article-container">
      ...
      <article class="article-content" v-if="article">
        <span class="meta-tag">📍 {{ article.location }} • Ngày đăng: {{ article.date }}</span>
        ...
        <div class="article-body">
          <div class="article-img-wrap">
            ...
            <span class="img-caption">Hình ảnh anh/chị {{ article.name }} năng nổ, tích cực làm việc trong ngày hội sản xuất.</span>
          </div>
