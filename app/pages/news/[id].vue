...
const categoryLabel = computed(() => {
  ...
  if (!a) return ''
  return a.categoryName || typeLabels[a.type] || 'Thông tin'
})
...
useSeoMeta({
  title: computed(() => article.value ? `${article.value.title} | Con Đường Hướng Thiện` : 'Chi tiết tin tức | Con Đường Hướng Thiện'),
  description: computed(() => article.value?.excerpt || 'Tin tức và hoạt động hỗ trợ hoàn lương, tái hòa nhập cộng đồng.'),
})
</script>
