...
- **MySQL Database Auto-Init (`server/db/init.ts`)**: Tự động kết nối server MySQL, tạo database `cdkt_admin` và toàn bộ 30 bảng dữ liệu nếu chưa tồn tại (idempotent, tự thêm cột còn thiếu).
